...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  ...
  <tr>
    ...
    <a href="showAddUpUser.php?id=<?php echo $id?>&username=<?php echo $username?>" target="mainFrame" onFocus="this.blur()" class="add">添加个人资料</a>
    </td>
  </tr>
  <tr>
    <?php
  ...
  <td align="left" valign="top">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <input type="text" name="username" value="<?php echo $array['username'];?>" class="text-word">
        </td>
        </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">用户密码：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <input type="password" name="password" value="<?php echo $array['password'];?>" class="text-word">
        </td>
        </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">确认密码：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <input type="password" name="repassword" value="<?php echo $array['password'];?>" class="text-word">
        </td>
      </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">用户级别：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <select name="auth" id="auth">
          <?php
             if($array['auth']==1){
              echo "<option value='$array[auth]' selectd>管理员</option>";
              echo "<option value='0'>普通用户</option>";
             }else{
              echo "<option value='$array[auth]' selectd>普通用户</option>";
