...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      if(isset($_GET['search'])){
        $where = "where recycle=0 and title like '%{$_GET['search']}%'";
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="center" valign="middle" class="borderbottom">
          <a href="./vPost.php?id=<?php echo $array['id'];?>" target="mainFrame" onFocus="this.blur()" class="add">查看帖子</a>
          <span class="gray">&nbsp;|&nbsp;</span>
          <a href="./updatePost.php?id=<?php echo $array['id'];?>" target="mainFrame" onFocus="this.blur()" class="add">编辑</a>
          <span class="gray">&nbsp;|&nbsp;</span>
          <a href="./upTrashPost.php?id=<?php echo $array['id'];?>" target="mainFrame" onFocus="this.blur()" class="add">放入回收站</a>
          <span class="gray">&nbsp;|&nbsp;</span>
          <a href="upElite.php?elite=<?php echo $array['elite'];?>&id=<?php echo $array['id'];?>" target="mainFrame" onFocus="this.blur()" class="add">
            <?php echo $array['elite']?$elite['0']:$elite['1'];?>
          </a>
          <span class="gray">&nbsp;|&nbsp;</span>
          <a href="upTop.php?top=<?php echo $array['top'];?>&id=<?php echo $array['id'];?>" target="mainFrame" onFocus="this.blur()" class="add">
            <?php echo $array['top']?$top['0']:$top['1'];?>
          </a>
          <span class="gray">&nbsp;|&nbsp;</span>
          <a href="../reply/List.php?id=<?php echo $array['id'];?>" target="mainFrame" onFocus="this.blur()" class="add">管理回复</a>
          <span class="gray">&nbsp;|&nbsp;</span>
          <a href="./upDelPost.php?id=<?php echo $array['id'];?>" target="mainFrame" onFocus="this.blur()" class="add">删除</a>
        </td>
      </tr>
     <?php }?>
    </table></td>
    ...
    <?php
      // 上一页
       ...
       //下一页
      $sql2 = "select count(*) as count from post where recycle=0";
  ...
  <tr>
    <td align="left" valign="top" class="fenye"><?php echo $totalCo;?> 条数据 <?php echo $totalPage?>/<?php echo $nowPage?> 页&nbsp;&nbsp;
      <a href="./post.php?page=1" target="mainFrame" onFocus="this.blur()">首页</a>&nbsp;&nbsp;
      <a href="./post.php?page=<?php echo $prevPage.$url?>" target="mainFrame" onFocus="this.blur()">上一页</a>&nbsp;&nbsp;
      <a href="./post.php?page=<?php echo $nextPage.$url?>" target="mainFrame" onFocus="this.blur()">下一页</a>&nbsp;&nbsp;
      <a href="./post.php?page=<?php echo $totalPage.$url?>" target="mainFrame" onFocus="this.blur()">尾页</a></td>
  </tr>
</table>
</body>
<?php mysql_close();?>
