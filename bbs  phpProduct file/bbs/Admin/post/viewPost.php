...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  ...
  <tr>
    ...
    <a href="./postList.php?id=<?php echo $_GET['tid']?>&name=<?php echo $_GET['name']?>" target="mainFrame" onFocus="this.blur()" class="add">返回上一级</a>
    </td>
  </tr>
  <tr>
    ...
    mysql_select_db('bbs');
    $sql = "select post.*,user.username from post,user where post.uid=user.id and post.id={$id}";
    $rel =mysql_query($sql);
    $arra=mysql_fetch_assoc($rel);
   

  ?>
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">帖子主题：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for"><?php echo $arra['title']?></td>
        </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">发帖人</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for"><?php echo $arra['username']?></td>
        </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">发表时间：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for"><?php echo date('Y-m-d H:i:s',$arra['time'])?></td>
      </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
		...
		<pre>
		　<?php echo $arra['content'];?>
		</pre>
		</td>
      </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">帖子状态：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
          <a class="add"><?php echo $arra['elite']?$elite['1']:$elite['0'];?></a>
          <span class="gray">&nbsp;|&nbsp;</span>
          <a class="add"><?php echo $arra['top']?$top['1']:$top['0'];?></a>
        </td>
      </tr>
      <!--<tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
