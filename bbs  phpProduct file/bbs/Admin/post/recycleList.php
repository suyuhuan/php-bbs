...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：回收站</td>
  </tr>
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
  		<tr>
   		 <td width="90%" align="left" valign="middle">
	         <form method="get" action="./recycleList.php">
	         <span>帖子名：</span>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      if(isset($_GET['search'])){
        $where = "where recycle=1 and post.uid=user.id and title like '%{$_GET['search']}%'";
        $url = "&search ={$_GET['search']}";
      }else{
        $where = "where recycle=1 and post.uid=user.id";
        $url = "";
      }
      //分页
      $page = 3;
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="center" valign="middle" class="borderbottom">
          <a href="./viewPost.php?id=<?php echo $array['id'];?>" target="mainFrame" onFocus="this.blur()" class="add">查看帖子</a>
          <span class="gray">&nbsp;|&nbsp;</span>
          <a href="./delTrash.php?id=<?php echo $array['id'];?>" target="mainFrame" onFocus="this.blur()" class="add">删除</a>
          <span class="gray">&nbsp;|&nbsp;</span>
          <a href="./doRegPost.php?id=<?php echo $array['id'];?>" target="mainFrame" onFocus="this.blur()" class="add">恢复</a></td>
      </tr>
     <?php }?>
    </table></td>
    </tr>
    <?php
      // 上一页
       ...
       //下一页
      $sql2 = "select count(*) as count from post where recycle=1";
   ...
   <tr>
    <td align="left" valign="top" class="fenye"><?php echo $totalCo;?> 条数据 <?php echo $totalPage;?>/<?php echo $nowPage?> 页&nbsp;&nbsp;
      <a href="./recycleList.php?page=1" target="mainFrame" onFocus="this.blur()">首页</a>&nbsp;&nbsp;
      <a href="./recycleList.php?page=<?php echo $prevPage.$url?>" target="mainFrame" onFocus="this.blur()">上一页</a>&nbsp;&nbsp;
      <a href="./recycleList.php?page=<?php echo $nextPage.$url?>" target="mainFrame" onFocus="this.blur()">下一页</a>&nbsp;&nbsp;
      <a href="./recycleList.php?page=<?php echo $totalPage.$url?>" target="mainFrame" onFocus="this.blur()">尾页</a></td>
  </tr>
</table>
</body>
<?php mysql_close();?>
