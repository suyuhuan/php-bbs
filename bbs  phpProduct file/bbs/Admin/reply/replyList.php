...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  ...
  <tr>
    ...
    <a href="../post/postList.php?id=<?php echo $_GET['tid']?>&name=<?php echo $_GET['name']?>" target="mainFrame" onFocus="this.blur()" class="add">返回上一级</a>
    </td>
  </tr>
  <tr>
    ...
    <form method="post" action="">
      <?php 
         ...
         $sql = "select post.title,user.username,reply.* from post,user,reply where reply.uid=user.id and reply.pid =post.id and reply.pid={$pid};";
         $rel =mysql_query($sql);
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="left" valign="middle" class="borderright borderbottom main-for"><?php echo $array['title'];?></td>
       </tr>

      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">回复相关：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
          <?php echo $array['username'];?>&nbsp;&nbsp;<?php echo date('Y-m-d H:i:s',$array['time']);?>&nbsp;&nbsp;
          <a href="./delReplyList.php?id=<?php echo $array['id'];?>&pid=<?php echo $pid?>" target="mainFrame" onFocus="this.blur()" class="add">删除</a></td>
      </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
